              ...
              <div class="col">
               ...
               <div class="row">
                 ...
                 <div class="modal-footer">
                    ...
                    <button type="submit" name="addstu" onclick="return confirm('Are you sure?')" class="btn btn-primary">Save</button>
                </div>
          </div>
            </form>
          </div>
...
?>
            ...
            <div class="card">
               ...
               <div class="col">
                    ...
                    <div class="col">
                    <a href="#" data-toggle="modal" data-target="" class="btn btn-primary float-left" >Show Data</a>
                    </div>
                    </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                               ...
                               //$ses = <? php echo $ses
                               //$sess='2023-24';
                                //$get_data = "SELECT student_data.*, institute.sese FROM student_data, institute where student_data.ses = $sess";
                                $get_data = "SELECT student_data.*, institute.sese FROM student_data, institute ";
                                //echo $sess
                               
                                $run_data = mysqli_query($con,$get_data);
                               // $run_data->execute([$sess]);
                                //$i = 0; 
