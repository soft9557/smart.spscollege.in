          ...
          <div class="col-md 12">
            ...
            <div class="card">
               <div class="card-header">
                 <!-- Student Report -->
                         <form action="studenticard.php" method="POST" >
                              <div class="row"> 
                                      <div class="col">
                                       ...
                                       <div class="col">
                                         ...
                                         <div class="col">
                                                ...
                                                <select name="adid" id="adid" value="<?php echo $adid?>"  class="form-control" >
