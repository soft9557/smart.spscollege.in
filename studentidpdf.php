<?php 
  ...
  $info=[
   ...
   $sql="select student_data.*, date_format(st_dob,'%d-%m-%Y') as dobdate,institute.inst_name as college,institute.img as logo,institute.mob1 as mob1,institute.mob2 as mob2,institute.sese as session,
   institute.addr1 as add1,institute.addr2 as add2,institute.addr3 as add3,institute.addr4 as add4,institute.ins_email as email,institute.website as web  from student_data,institute 
  ...
  class PDF extends FPDF
  {
    ...
    function body($info,$products_info){
      ...
      if (file_exists($info["logo"])) {
        ...
        $this->Image($imagePath,5,9,20,20,"JPG");
    }
      ...
      $this->SetX(10);
      $this->SetFont('Arial','B',10);
      $this->Cell(50,10,"Registration No : ".$info["regno"]);
      $this->SetY(42);
      $this->SetX(80);
      $this->SetFont('Arial','',10);
      $this->Cell(50,10,"Aadhar No : ".$info["adhno"]);
      ...
      if (file_exists($info["stphoto"])) {
       ...
       // list($width, $height) = getimagesize($info["stphoto"]);
        $this->Image($info["stphoto"],160,35,20,20,"JPG");
      } else {
        // Handle the error when image file is not found
        $this->Image('images/default-avatar.jpg',160,35,20,20,"JPG");
    }
     ...
     // $this->Cell(50,7,"Fee Date : ".$info["date"]);
      ...
      $this->Cell(45,9,"Examination",1,0,"L");
      $this->Cell(50,9,"Board/University",1,0,"L");
      $this->Cell(20,9,"Year",1,0,"C");
      $this->Cell(20,9,"%Marks",1,0,"C");
      $this->Cell(50,9,"Subject",1,1,"C");
      $this->SetFont('Arial','',10);
      
      //Display table product rows
      foreach($products_info as $row){
        $this->Cell(7,9,$row["sr"],"LR",0);
        $this->Cell(45,9,$row["exam1"],"R",0,"L");
        $this->Cell(50,9,$row["board1"],"R",0,"L");
        $this->Cell(20,9,$row["year1"],"R",0,"C");
        $this->Cell(20,9,$row["marks1"],"R",0,"C");
        $this->Cell(50,9,$row["sub1"],"R",1,"L");
        $this->Cell(7,11,$row["sr2"],"LR",0);
        $this->Cell(45,11,$row["exam2"],"R",0,"L");
        $this->Cell(50,11,$row["board2"],"R",0,"L");
        $this->Cell(20,11,$row["year2"],"R",0,"C");
        $this->Cell(20,11,$row["marks2"],"R",0,"C");
        $this->Cell(50,11,$row["sub2"],"R",1,"L");
        $this->Cell(7,11,$row["sr3"],"LR",0);
        $this->Cell(45,11,$row["exam3"],"R",0,"L");
        $this->Cell(50,11,$row["board3"],"R",0,"L");
        $this->Cell(20,11,$row["year3"],"R",0,"C");
        $this->Cell(20,11,$row["marks3"],"R",0,"C");
        $this->Cell(50,11,$row["sub3"],"R",1,"L");
      }
      ...
      $this->SetFont('Arial','B',12);
      $this->Cell(142,9,"",1,0,0,0,"R");
      $this->Cell(50,9,"",1,0,0,0,"R");
