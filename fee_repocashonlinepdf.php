...
if(isset($_POST['ptype'])){
 ...
 if($ptype!==''){
    ...
    if($from!=='' && $to!=''){
        $sub_sql=" paid_date between '$from' and '$to' ";
    }
   ...
   //	$sub_sql=" and party.id=$party_id ";
            ...
            $res=mysqli_query($con,"SELECT fee_data.*,date_format(paid_date,'%d-%m-%Y') as date FROM fee_data where $sub_sql AND $sqlp order by id");
            ...
            if(mysqli_num_rows($res1)>0){
                         ...
                         while($row1=mysqli_fetch_assoc($res1)){
                           // $imagePath="" .$row1['img']. "";
                            ...
                            $html2.="<h5 style='text-align:left'>Student Fee Report- " .$row1['sese']."( Date From - " .$f." To - " .$t.")"."</h5>";
