  ...
  <!-- Content Header (Page header) -->
          <div class="content-header">
            <div class="container-fluid">
                            <div class="row mb-2">
                                      <div class="col-sm-6">
                                        <h5 style="color:blue" class="m-0">Student Profile Report</h5>
                                      </div><!-- /.col -->
                                      <div class="col-sm-6">
                                        <ol class="breadcrumb float-sm-right">
                                          <li class="breadcrumb-item"><a href="#">Home</a></li>
                                          <li class="breadcrumb-item active">Student Profile Report</li>
                                        </ol>
                                      </div><!-- /.col -->
                              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                 ...
                 <!-- /.card-header -->
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php
                                ...
                                <td>                            
                                  <a href ="studentpropdf.php?id=<?php echo $row['id']; ?>" class="btn btn-primary ">Print/Download</a> 
                                </td>
                              </tr>
                                <?php
                                }
